...
Commands:
  ...
  sync    Update .sage/targets.gen.go and sync workflows to .github/workflows`)
}
...
func runInit(args []string) error {
	...
	if _, err := os.Stat(".sage/sagefile.go"); err == nil {
		return errors.New(".sage/sagefile.go already exists, use 'sync' to update targets.gen.go")
	}
	...
	if err := os.WriteFile(".sage/targets.gen.go", []byte("// Code generated by sage-ci. DO NOT EDIT.\n\n"+syncedContent), 0o644); err != nil {
		return fmt.Errorf("write .sage/targets.gen.go: %w", err)
	}

	fmt.Println("Initialized .sage/sagefile.go and .sage/targets.gen.go")
...
func runSync(args []string) error {
	...
	// Update targets.gen.go if .sage directory exists
	if _, err := os.Stat(".sage"); err == nil {
		if err := os.WriteFile(".sage/targets.gen.go", []byte("// Code generated by sage-ci. DO NOT EDIT.\n\n"+syncedContent), 0o644); err != nil {
			return fmt.Errorf("write .sage/targets.gen.go: %w", err)
		}
		fmt.Println("Updated .sage/targets.gen.go")
	}
